...
def write_to_csv(service, csvwriter, resource, metrics_info):
    if service == 'ec2':
        ...
        csvwriter.writerow([
            ...
            numpy.round(numpy.average(metrics_info['EBSReadOps']), 2),
            numpy.round(numpy.average(metrics_info['EBSWriteOps']), 2),
            numpy.round(numpy.average(metrics_info['EBSReadBytes']), 2),
            numpy.round(numpy.average(metrics_info['EBSWriteBytes']), 2),
